...
void ClipDistortion::_bind_methods() {
	...
	ClassDB::bind_method(D_METHOD("set_threshold_base_value", "value"), &ClipDistortion::set_threshold_base_value);
	ClassDB::bind_method(D_METHOD("get_threshold_base_value"), &ClipDistortion::get_threshold_base_value);
	ClassDB::bind_method(D_METHOD("set_hardness_base_value", "value"), &ClipDistortion::set_hardness_base_value);
	ClassDB::bind_method(D_METHOD("get_hardness_base_value"), &ClipDistortion::get_hardness_base_value);

	ClassDB::bind_method(D_METHOD("set_drive_base_value", "value"), &ClipDistortion::set_drive_base_value);
	ClassDB::bind_method(D_METHOD("get_drive_base_value"), &ClipDistortion::get_drive_base_value);
	ClassDB::bind_method(D_METHOD("set_mix_base_value", "value"), &ClipDistortion::set_mix_base_value);
	ClassDB::bind_method(D_METHOD("get_mix_base_value"), &ClipDistortion::get_mix_base_value);
	ClassDB::bind_method(D_METHOD("set_output_gain_base_value", "value"), &ClipDistortion::set_output_gain_base_value);
	ClassDB::bind_method(D_METHOD("get_output_gain_base_value"), &ClipDistortion::get_output_gain_base_value);
	...
	ADD_PROPERTY(PropertyInfo(Variant::FLOAT, "hardness", PROPERTY_HINT_RANGE, "0,1,0.01"),
			"set_hardness_base_value", "get_hardness_base_value");
...
void ClipDistortion::set_threshold_base_value(float p_value) {
...
float ClipDistortion::get_threshold_base_value() const {
	return get_parameter(PARAM_THRESHOLD)->get_base_value();
}

void ClipDistortion::set_hardness_base_value(float p_value) {
	Ref<ModulatedParameter> param = get_parameter(PARAM_HARDNESS);
	if (param.is_valid()) {
		param->set_base_value(p_value);
	}
}

float ClipDistortion::get_hardness_base_value() const {
	return get_parameter(PARAM_HARDNESS)->get_base_value();
}

void ClipDistortion::set_drive_base_value(float p_value) {
...
float ClipDistortion::get_drive_base_value() const {
	return get_parameter(PARAM_DRIVE)->get_base_value();
}

void ClipDistortion::set_mix_base_value(float p_value) {
...
float ClipDistortion::get_mix_base_value() const {
	return get_parameter(PARAM_MIX)->get_base_value();
}

void ClipDistortion::set_output_gain_base_value(float p_value) {
...
float ClipDistortion::get_output_gain_base_value() const {
