...
void WaveShaperDistortion::_bind_methods() {
	...
	ClassDB::bind_method(D_METHOD("set_shape_base_value", "value"), &WaveShaperDistortion::set_shape_base_value);
	ClassDB::bind_method(D_METHOD("get_shape_base_value"), &WaveShaperDistortion::get_shape_base_value);
	ClassDB::bind_method(D_METHOD("set_symmetry_base_value", "value"), &WaveShaperDistortion::set_symmetry_base_value);
	ClassDB::bind_method(D_METHOD("get_symmetry_base_value"), &WaveShaperDistortion::get_symmetry_base_value);
	ClassDB::bind_method(D_METHOD("set_drive_base_value", "value"), &WaveShaperDistortion::set_drive_base_value);
	ClassDB::bind_method(D_METHOD("get_drive_base_value"), &WaveShaperDistortion::get_drive_base_value);
	ClassDB::bind_method(D_METHOD("set_mix_base_value", "value"), &WaveShaperDistortion::set_mix_base_value);
	ClassDB::bind_method(D_METHOD("get_mix_base_value"), &WaveShaperDistortion::get_mix_base_value);
	ClassDB::bind_method(D_METHOD("set_output_gain_base_value", "value"), &WaveShaperDistortion::set_output_gain_base_value);
	ClassDB::bind_method(D_METHOD("get_output_gain_base_value"), &WaveShaperDistortion::get_output_gain_base_value);
	...
	ADD_PROPERTY(PropertyInfo(Variant::FLOAT, "shape", PROPERTY_HINT_RANGE, "0,1,0.01"),
			"set_shape_base_value", "get_shape_base_value");
	...
	ADD_PROPERTY(PropertyInfo(Variant::FLOAT, "symmetry", PROPERTY_HINT_RANGE, "0,1,0.01"),
			"set_symmetry_base_value", "get_symmetry_base_value");
...
void WaveShaperDistortion::set_shape_base_value(float p_value) {
	Ref<ModulatedParameter> param = get_parameter(PARAM_SHAPE);
	if (param.is_valid()) {
		param->set_base_value(p_value);
	}
}

float WaveShaperDistortion::get_shape_base_value() const {
	return get_parameter(PARAM_SHAPE)->get_base_value();
}

void WaveShaperDistortion::set_symmetry_base_value(float p_value) {
	Ref<ModulatedParameter> param = get_parameter(PARAM_SYMMETRY);
	if (param.is_valid()) {
		param->set_base_value(p_value);
	}
}

float WaveShaperDistortion::get_symmetry_base_value() const {
	return get_parameter(PARAM_SYMMETRY)->get_base_value();
}

void WaveShaperDistortion::set_drive_base_value(float p_value) {
...
float WaveShaperDistortion::get_drive_base_value() const {
	return get_parameter(PARAM_DRIVE)->get_base_value();
}

void WaveShaperDistortion::set_mix_base_value(float p_value) {
...
float WaveShaperDistortion::get_mix_base_value() const {
	return get_parameter(PARAM_MIX)->get_base_value();
}

void WaveShaperDistortion::set_output_gain_base_value(float p_value) {
...
float WaveShaperDistortion::get_output_gain_base_value() const {
